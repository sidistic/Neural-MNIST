...
for i in range(16):
  plt.subplot(4,4,i+1)
  plt.tight_layout()
  plt.imshow(x_test_noisy[i+1000], cmap='gray', interpolation='none')
  plt.title("Digit: {}".format(y_test[i+1000]))
  plt.xticks([])
  plt.yticks([])
fig
...
for i in range(16):
  plt.subplot(4,4,i+1)
  plt.tight_layout()
  plt.imshow(pred_test[i+1000], cmap='gray', interpolation='none')
  plt.title("Digit: {}".format(y_test[i+1000]))
  plt.xticks([])
  plt.yticks([])
fig
