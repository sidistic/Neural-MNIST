...
data_path='/home/sidistic/MNIST_data/mnist_png/training';
...
rand_loc=randi(size(image,1),30000,1);

rand_loc_trans=rand_loc(1:10000);
rand_loc_rot=rand_loc(10001:20000);
rand_scal=rand_loc(20001:30000);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
img_rot=image(rand_loc_rot,:,:);
 r = randi([-60 60],10000,1);
 for ii=1:10000
...
save('mnist_modified_image_train.mat','modified_image');    %modified image
save('mnist_image_train.mat','image');                  %orginal image
save('mnist_image_label_train.mat','label');            %label files
save('mnist_modified_rand_loc_train.mat','rand_loc');   % random loacations
